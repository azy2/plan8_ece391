        ...
        format_char_switch:
            ...
            case 'x':
            {
                ...
                if(alternate == 0) {
                    ...
                    write(1, conv_buf, strlen(conv_buf));
                } else {
                    ...
                    write(1, &conv_buf[starting_index], strlen(&conv_buf[starting_index]));
                }
                esp++;
            }
            break;
            ...
            case 'c':
                write(1, (uint8_t *) ((int32_t *)esp), 1);
                esp++;
                break;

                /* Print a NULL-terminated string */
            case 's':
                write(1, *((uint8_t **)esp), strlen(*((uint8_t **)esp)));
                esp++;
                break;
